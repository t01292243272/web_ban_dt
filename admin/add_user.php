...
if(isset($_POST['sbm'])){
    ...
    elseif(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM user WHERE user_mail='".$user_mail."'" )) >0){
        $err2 = '<div class="alert alert-danger">Email đã tồn tại !</div>';}
    else{$sql = "INSERT INTO user (user_full, user_mail, user_pass, user_level)
